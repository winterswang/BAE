...
<div class="docbody" id="house_publish" >
    <form action="/house/publish" method="post" name="house_form">
        ...
        <div class ="row">
            <label>楼层</label>
            第 <input type="number" max="99" min="1" name="floor_on" value=""  required/> 层
            共 <input type="number" max="99" min="1" name="floor_all" value=""  required/> 层
        </div>
        <div class ="row">
            <label>户型</label>
            <input type="number" max="100" min="0" name="room" value="" required  /> 室
            <input type="number" max="100" min="0" name="hall" value="" required /> 厅                   
            <input type="number" max="100" min="0" name="wc" value="" required  /> 卫
        </div>
