...
if (!defined( "ROOT_WIDGET_LIB_PATH" )) {
	define( "ROOT_WIDGET_LIB_PATH", ROOT_TOP_PATH . "/fe-lib/widget");
}
...
class WinBase{
	...
	static $_coreClasses = array(
		"BeanFinder" => "/lib/winphp/BeanFinder.class.php",
		"Benchmark" => "/lib/winphp/Benchmark.php",
		...
		"File" => "/lib/winphp/File.class.php",
		"Local" => "/lib/winphp/Local.class.php",
		"Uri" => "/lib/winphp/Uri.class.php",
		"Json" => "/lib/winphp/Json.class.php",
		"WinRequest" => "/lib/winphp/WinRequest.class.php",
		'Session' => "/lib/winphp/Session.class.php",
		'Pager' => "/lib/winphp/Pager.class.php",
